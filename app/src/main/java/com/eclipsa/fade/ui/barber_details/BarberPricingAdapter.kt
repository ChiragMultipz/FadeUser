...
import com.eclipsa.fade.databinding.ItemBarberPricingBinding
...
class BarberPricingAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (services.isSelected!!) {
            ...
            holder.binding.tvAddService.setTextColor(ContextCompat.getColor(context, R.color.white))
        } else {
            holder.binding.tvAddService.setBackgroundResource(R.drawable.drawable_add_service_btn_grey_bg)
            holder.binding.tvAddService.setTextColor(
