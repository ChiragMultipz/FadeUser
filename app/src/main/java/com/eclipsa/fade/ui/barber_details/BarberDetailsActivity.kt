...
import com.eclipsa.fade.ServicesItem
import com.eclipsa.fade.databinding.ActivityBarberDetailsBinding
...
class BarberDetailsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun selectedButton(tvSelectedTextView: TextView) {
        ...
        tvSelectedTextView.setTextColor(ContextCompat.getColor(this, R.color.white))
    }
