package com.eclipsa.fade.ui.payment_details
...
import com.eclipsa.fade.databinding.ActivityPaymentDetailsBinding
import com.eclipsa.fade.extension.loadingImage
import com.eclipsa.fade.extension.snackBar
...
import com.eclipsa.fade.utils.CreditCardNumberFormattingTextWatcher
import com.eclipsa.fade.utils.Prefrences
import com.eclipsa.fade.utils.Utils
import com.eclipsa.fade.utils.Utils.enable
import com.eclipsa.fade.utils.Utils.getAddress
import com.eclipsa.fade.utils.Utils.handleApiError
...
class PaymentDetailsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*val binancePay1 = BinancePayFactory.getBinancePay(context)
        binancePay1.pay(orderId, type, listener)*/
    ...
    private fun setClickListener() {
        ...
        binding.relCrypto.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.relCrypto-> {
                ...
                val param = BinancePayParam("258257922", "258257922", "$timeStamp", "", Constants.BINANCE_API_KEY, "Chiku")
