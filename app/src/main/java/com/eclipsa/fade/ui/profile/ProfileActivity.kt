...
import com.eclipsa.fade.ui.get_location.GetLocationActivity
import com.eclipsa.fade.utils.*
...
import com.eclipsa.fade.utils.Utils.visible
...
class ProfileActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvCountryCode.text =
            "+${Prefrences.getPreferences(context, "CountryCodeNew").toString()}"
            ...
            when (it) {
                is Resource.Success -> {
                    if (it.value.result != null) {
                        ...
                        if (isFirstTime.equals("YES")) {
                            val i = Intent(this@ProfileActivity, com.eclipsa.fade.MainActivity::class.java)
                            i.flags =
        ...
        if (binding.tvEditProfile.text.equals("Edit Profile")) {
            ...
            if (name.isEmpty()) {
                ...
                if (mCurrentPhotoPath != null) {
                    ...
                    parts.add(body)
                    params["phone_code"] =
                        Prefrences.getPreferences(context, Constants.SELECTED_COUNTRY_CODE)!!
                    params["name"] = name
    ...
    private fun showSingleImage(uri: Uri) {
        mCurrentPhotoPath = com.eclipsa.fade.utils.FileUtil.getPath(context, uri)
        Glide.with(context).load(mCurrentPhotoPath).into(binding.ivUserProfile)
    }
