...
import com.eclipsa.fade.databinding.ActivityAddReviewBinding
...
import com.eclipsa.fade.utils.Utils.compressImage
...
class AddReviewActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showSingleImage(uri: Uri) {
        mCurrentPhotoPath = com.eclipsa.fade.utils.FileUtil.getPath(ToastUtil.context, uri)
